...
```bash
origin  https://github.com/[yourUserName]/auro-kit.git (fetch)
origin  https://github.com/[yourUserName]/auro-kit.git (push)
```

To add the upstream repo to your local forked project

```bash
$ git remote add upstream https://github.com/AlaskaAirlines/auro-kit.git
```
...
origin  https://github.com/[yourUserName]/auro-kit.git (fetch)
origin  https://github.com/[yourUserName]/auro-kit.git (push)
upstream        https://github.com/AlaskaAirlines/auro-kit.git (fetch)
upstream        https://github.com/AlaskaAirlines/auro-kit.git (push)
```
