...
/**
 * The auro-kit element provides users a way to ... (it would be great if you fill this out).
 *
...
export class AuroKit extends LitElement {
  // constructor() {
  //   super();
  // }
...
if (!customElements.get("auro-kit")) {
  customElements.define("auro-kit", AuroKit);
}
